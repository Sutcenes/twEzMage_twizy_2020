...
public class MaBibliothequeTraitementImage {
	...
	public static Mat seuillage(Mat input, int seuilRougeOrange, int seuilRougeViolet,int seuilSaturation){
		...
		Core.inRange(input, new Scalar(0,seuilSaturation,seuilSaturation), new Scalar(seuilRougeOrange,255,255), threshold_img1);	//bleu: 216*179/360, 100, 100 : 236*179/360, 255, 255
